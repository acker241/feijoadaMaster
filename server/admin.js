...
<div class="wrap">
  ...
  <h1>Feijoada <span>do Master</span></h1>
  <div class="bar">${chips}<span class="sp"></span><a class="pill" href="/admin/noticias">notícias</a><a class="pill" href="/admin/stats">estatísticas</a><a class="pill" href="/admin/conteudo">editar conteúdo</a><a class="pill" href="/admin/export.csv">baixar CSV</a><a class="pill" href="/admin/sair">sair</a></div>
